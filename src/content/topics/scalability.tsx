...
export const scalabilityContent: TopicContent = {
  introduction: `Amazon system design is the capability of a system to handle growing amounts of work by adding resources. 
  ...
  sections: [
    {
      ...
      content: `Scalability isn't just about handling more users—it's about doing so efficiently and cost-effectively. 
      There are two primary approaches to scaling: horizontal and vertical. Each has its own advantages and use cases.`,
      image: "/placeholder.svg"
    },
    {
      title: "Horizontal Scaling (Scale Out)",
      content: `Horizontal scaling means adding more machines to your pool of resources. Instead of upgrading a single server, 
      you distribute the load across multiple servers. This is the preferred approach for cloud-native applications.
      
      Benefits:
      • Better fault tolerance - if one server fails, others continue serving
      • No single point of failure
      • Can scale indefinitely by adding more machines
      • Cost-effective as you can use commodity hardware
